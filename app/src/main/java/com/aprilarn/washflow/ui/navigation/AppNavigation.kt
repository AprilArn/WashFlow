...
sealed class AppNavigation(val route: String, val icon: ImageVector, val label: String) {
    ...
    // --- PERUBAHAN DI SINI ---
    // Rute-rute ini masih ada, tapi tidak ditampilkan di nav bar
    ...
    object TableData : AppNavigation("table_data", Icons.Default.Storage, "Data") // Ikon 'Storage' sebagai contoh
